...
-- AddForeignKey
ALTER TABLE "WatchlistItems" ADD CONSTRAINT "WatchlistItems_userId_fkey" FOREIGN KEY ("userId") REFERENCES "Users"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "WatchlistItems" ADD CONSTRAINT "WatchlistItems_movieId_fkey" FOREIGN KEY ("movieId") REFERENCES "Movies"("id") ON DELETE CASCADE ON UPDATE CASCADE;
